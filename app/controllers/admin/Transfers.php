...
class Transfers extends MY_Controller
{
    public function __construct()
    {
        ...
        $this->data['userGroupName'] = $this->site->getUserGroupName($this->session->userdata('user_id'));
    }
    ...
    {
        $this->sma->checkPermissions('add', null, 'transfers');
        ...
        $userGroupName = $this->site->getUserGroupName($this->session->userdata('user_id'));
        ...
        if ($this->form_validation->run() == true) {
            ...
            $this->data['business_locations'] = $this->site->getAllBusiness_location();
            $this->data['rnumber']    = $this->site->getReference('to');
            $this->data['groupName'] = $userGroupName;
