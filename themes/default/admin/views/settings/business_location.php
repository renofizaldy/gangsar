...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#CURData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('system_settings/getBusiness_location') ?>',
...
<?= admin_form_open('system_settings/business_location_actions', 'id="action-form"') ?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?php echo admin_url('system_settings/add_business_location'); ?>" data-toggle="modal" data-target="#myModal">
                                <i class="fa fa-plus"></i> <?= lang('add_business_location') ?>
                            </a>
                            </li>
                        <li>
                        ...
                        <li>
                            <a href="#" id="delete" data-action="delete">
                                <i class="fa fa-trash-o"></i> <?= lang('delete_business_locations') ?>
                            </a>
                        </li>
