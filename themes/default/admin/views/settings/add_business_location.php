...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('add_business_location'); ?></h4>
        </div>
        <?php $attrib = ['data-toggle' => 'validator', 'role' => 'form'];
        echo admin_form_open_multipart('system_settings/add_business_location', $attrib); ?>
        <div class="modal-body">
            ...
            <div class="form-group">
                <?= lang('business_location_map', 'image') ?>
        ...
        <div class="modal-footer">
            <?php echo form_submit('add_business_location', lang('add_business_location'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
